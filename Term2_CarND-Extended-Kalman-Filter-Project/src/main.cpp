...
void read_file(ifstream &in_file, vector<MeasurementPackage> &, vector<GroundTruthPackage> &);
...
void read_file(ifstream &in_file_, vector<MeasurementPackage> &measurement_pack_list, vector<GroundTruthPackage> &gt_pack_list){
  string line;
